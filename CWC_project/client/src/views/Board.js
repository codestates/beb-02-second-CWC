...
function Board() {
  ...
  return (
    <div className="Board-container">
      <h1 className="Board-logo-name">
        CWC's Community Guidelines
        <p className="Board-logo-paragrph">
          When you use CWC, you join a community of people from all over the
          world. The guidelines below help keep CWC fun and enjoyable for
          everyone. If you see content that you think violates these guidelines,
          use the flagging feature to submit it for review by our CWC staff.
        </p>
      </h1>
      <div className="Board-welcome-page">
        <h2 className="Board-discussion-page">
          👋 Welcome to CWC Discussion Page!
        </h2>
      </div>
